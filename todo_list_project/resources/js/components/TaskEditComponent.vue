            ...
            <div>
              <div>
                ...
                <div class="form-row">
                  ...
                  <v-col cols="9" sm="”4”" id="form-text">
                    <v-text-field id="title" v-model="task.title" clearable></v-text-field>
                  </v-col>
                </div>
                ...
                <div class="form-row" style="height: 240px">
                  ...
                  <v-col cols="9" sm="”4”" id="form-text">
                    <v-textarea id="content" v-model="task.content" clearable outlined></v-textarea>
                  </v-col>
                </div>
                ...
                <div class="form-row">
                  ...
                  <v-col cols="9" sm="”4”" id="form-text">
                    <v-text-field id="person-in-charge" v-model="task.person_in_charge" clearable></v-text-field>
                  </v-col>
                </div>
              </div>
              <v-btn
